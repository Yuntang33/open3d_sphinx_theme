    ...
    grunt.initConfig({
                ...
                files: [
                    {
                        ...
                        dest: 'open3d_sphinx_theme/static/fonts/',
                        filter: 'isFile'
                    },
                    {
                        expand: true,
                        flatten: true,
                        src: ['fonts/Lato/*'],
                        dest: 'open3d_sphinx_theme/static/fonts/Lato',
                        filter: 'isFile'
                    },
                    {
                        expand: true,
                        ...
                        dest: 'open3d_sphinx_theme/static/fonts/RobotoSlab/',
                        filter: 'isFile'
                    }
                ]
            }
        ...
        sass: {
            dev: {
                ...
                files: [{
                    ...
                    cwd: 'sass',
                    src: ['*.sass'],
                    dest: 'open3d_sphinx_theme/static/css',
                    ext: '.css'
                }]
            },
            build: {
        ...
        browserify: {
            dev: {
                ...
                src: ['js/*.js'],
                dest: 'open3d_sphinx_theme/static/js/theme.js'
            },
            build: {
                options: {
                    external: ['jquery'],
        ...
        uglify: {
            dist: {
                ...
                files: [{
                    expand: true,
                    src: ['open3d_sphinx_theme/static/js/*.js', '!open3d_sphinx_theme/static/js/*.min.js'],
                    dest: 'open3d_sphinx_theme/static/js/',
        ...
        usebanner: {
            dist: {
                ...
                files: {
                    src: ['open3d_sphinx_theme/static/js/theme.js', 'open3d_sphinx_theme/static/css/theme.css']
                }
            }
        },
        exec: {
        ...
        clean: {
            build: ["docs/build"],
            fonts: ["open3d_sphinx_theme/static/fonts"],
            css: ["open3d_sphinx_theme/static/css"],
            js: ["open3d_sphinx_theme/static/js/*", "!open3d_sphinx_theme/static/js/modernizr.min.js"]
        },
        ...
        watch: {
            ...
            sphinx: {
                files: ['open3d_sphinx_theme/**/*', 'README.rst', 'docs/**/*.rst', 'docs/**/*.py'],
